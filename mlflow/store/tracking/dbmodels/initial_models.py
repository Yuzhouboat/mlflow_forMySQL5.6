...
class SqlExperiment(Base):
    ...
    """
    Experiment name: `String` (limit 150 characters). Defined as *Unique* and *Non null* in
                     table schema.
    """
    artifact_location = Column(String(150), nullable=True)
    """
    Default artifact location for this experiment: `String` (limit 150 characters). Defined as
...
class SqlRun(Base):
    ...
    """
    User ID: `String` (limit 150 characters). Defaults to ``null``.
    """
